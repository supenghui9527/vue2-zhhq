  ...
  export default {
    ...
    methods: {
      ...
      getfile (file, fileList) {
        seal(this, 'd:\\申请表.pdf', `${this.$route.query.diningApplyID * 1}`, '5')
        // FileUP.PJ_UpFile('d:\\申请表.pdf', 'http://58.213.150.99:8010/logistics/submitPDF.do', `${this.$route.query.diningApplyID * 1}`, '5')
      }
    }
  }
</script>
